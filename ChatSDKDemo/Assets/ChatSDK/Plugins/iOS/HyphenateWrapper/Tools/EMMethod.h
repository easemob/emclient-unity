...
static char *const MultiDevicesListener_Obj = "unity_chat_emclient_multidevice_delegate_obj";
...
static char *const ChatThreadListener_Obj = "unity_chat_emclient_threadmanager_delegate_obj";
