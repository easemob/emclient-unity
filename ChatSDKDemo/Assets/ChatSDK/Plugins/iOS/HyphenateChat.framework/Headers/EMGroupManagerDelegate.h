 ...
 */
typedef enum{
    EMGroupLeaveReasonBeRemoved = 0,    /*! \~chinese 被移除类型  \~english Removed by owner type*/
    EMGroupLeaveReasonUserLeave,        /*! \~chinese 自己主动离开类型  \~english User leave the group type*/
    EMGroupLeaveReasonDestroyed,        /*! \~chinese 群组销毁类型  \~english Group has been destroyed type*/
}EMGroupLeaveReason;
 ...
 *  Group List updated
 *
 *  @param aGroupList  Group NSArray<EMGroup>
 */
