 ...
 */
typedef enum {
    EMDownloadStatusDownloading   = 0,  /*! \~chinese 正在下载类型  \~english Downloading type */
    EMDownloadStatusSucceed,            /*! \~chinese 下载成功类型  \~english Succeed type*/
    EMDownloadStatusFailed,             /*! \~chinese 下载失败类型  \~english Failed type*/
    EMDownloadStatusPending,            /*! \~chinese 准备下载类型  \~english Pending type*/
    EMDownloadStatusSuccessed=EMDownloadStatusSucceed,   /*! \~chinese 旧版下载成功类型  \~english legacy type*/
} EMDownloadStatus;
