 ...
 */
typedef enum {
    EMConversationTypeChat  = 0,    /*! \~chinese 单聊会话类型  \~english one-to-one chat type */
    EMConversationTypeGroupChat,    /*! \~chinese 群聊会话类型  \~english group chat  type*/
    EMConversationTypeChatRoom      /*! \~chinese 聊天室会话类型  \~english chat room  type*/
} EMConversationType;
 ...
 */
typedef enum {
    EMMessageSearchDirectionUp  = 0,    /*! \~chinese 向上搜索类型  \~english Search older messages type*/
    EMMessageSearchDirectionDown        /*! \~chinese 向下搜索类型  \~english Search newer messages type*/
 ...
 *
 */
- (NSArray<EMMessage *> *)loadMessagesStartFromId:(NSString *)aMessageId
                          count:(int)aCount
 ...
 *
 */
- (NSArray<EMMessage *> *)loadMessagesWithKeyword:(NSString*)aKeyword
                      timestamp:(long long)aTimestamp
                          count:(int)aCount
 ...
 *
 */
- (NSArray<EMMessage *> *)loadCustomMsgWithKeyword:(NSString*)aKeyword
                       timestamp:(long long)aTimestamp
                           count:(int)aCount
                        fromUser:(NSString*)aSender
                 searchDirection:(EMMessageSearchDirection)aDirection;
 ...
 *
 */
- (NSArray<EMMessage *> *)loadMessagesFrom:(long long)aStartTimestamp
 ...
 */
- (BOOL)insertMessage:(EMMessage *)aMessage __deprecated_msg("Use -insertMessage:error: instead");
 ...
 *  @result Message insert result,  YES:  mean success,  NO:  mean failure.
 */
- (BOOL)appendMessage:(EMMessage *)aMessage __deprecated_msg("Use -appendMessage:error: instead");
 ...
 */
- (BOOL)updateMessage:(EMMessage *)aMessage __deprecated_msg("Use -updateMessageChange:error: instead");
 ...
 *  @param aDirection  Message search direction
 *
 *  @result Message NSArray<EMMessage>
 */
 ...
 *  @result Message instance
 */
- (EMMessage *)latestMessageFromOthers __deprecated_msg("Use -lastReceivedMessage instead");
