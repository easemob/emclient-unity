 ...
 */
typedef enum {
    EMChatTypeChat   = 0,   /*! \~chinese 单聊消息类型  \~english one to one chat type */
    EMChatTypeGroupChat,    /*! \~chinese 群聊消息类型  \~english Group chat type */
    EMChatTypeChatRoom,     /*! \~chinese 聊天室消息类型  \~english Chatroom chat type */
} EMChatType;
 ...
 */
typedef enum {
    EMMessageStatusPending  = 0,    /*! \~chinese 发送未开始类型 \~english Pending type*/
    EMMessageStatusDelivering,      /*! \~chinese 正在发送类型 \~english Delivering type*/
    EMMessageStatusSucceed,         /*! \~chinese 发送成功类型 \~english Succeed type*/
    EMMessageStatusFailed,          /*! \~chinese 发送失败类型 \~english Failed type*/
} EMMessageStatus;
 ...
 */
typedef enum {
    EMMessageDirectionSend = 0,    /*! \~chinese 发送的消息类型 \~english Send type*/
    EMMessageDirectionReceive,     /*! \~chinese 接收的消息类型 \~english Receive type*/
} EMMessageDirection;
