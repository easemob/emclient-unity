...
public class EMUnityChatManagerListener implements EMMessageListener, EMConversationListener {
    ...
    public void onMessageReceived(List<EMMessage> list) {
        ...
        UnityPlayer.UnitySendMessage(EMSDKMethod.ChatListener_Obj, "OnMessageReceived", "");
    }

    @Override
    public void onCmdMessageReceived(List<EMMessage> list) {
        Log.d("unity_sdk","onCmdMessageReceived");
        UnityPlayer.UnitySendMessage(EMSDKMethod.ChatListener_Obj, "OnCmdMessageReceived", "");
    }

    @Override
    public void onMessageRead(List<EMMessage> list) {
        Log.d("unity_sdk","onMessageRead");
        UnityPlayer.UnitySendMessage(EMSDKMethod.ChatListener_Obj, "OnMessageRead", "");
    }

    @Override
    public void onGroupMessageRead(List<EMGroupReadAck> list) {
        Log.d("unity_sdk","onGroupMessageRead");
        UnityPlayer.UnitySendMessage(EMSDKMethod.ChatListener_Obj, "OnGroupMessageRead", "");
    }
    ...
    public void onMessageDelivered(List<EMMessage> list) {
        ...
        UnityPlayer.UnitySendMessage(EMSDKMethod.ChatListener_Obj, "OnMessageDelivered", "");
    }

    @Override
    public void onMessageRecalled(List<EMMessage> list) {
        Log.d("unity_sdk","onMessageRecalled");
        UnityPlayer.UnitySendMessage(EMSDKMethod.ChatListener_Obj, "OnMessageRecalled", "");
    }
    ...
    public void onConversationRead(String s, String s1) {
        ...
        UnityPlayer.UnitySendMessage(EMSDKMethod.ChatListener_Obj, "OnConversationRead", "");
    }
}
