...
public:
    ...
    /**
     * \brief Get if this cmd msg is deliver to the online users only.
     *
     * @return
     */
    const bool isDeliverOnlineOnly() const { return mDeliverOnlineOnly; };

    /**
     * \brief Set whether this cmd msg is send to online users only.
     *
     * @param onlineOnly
     */
    void deliverOnlineOnly(const bool onlineOnly) { mDeliverOnlineOnly = onlineOnly; }
