...
public class EMRoomManagerWrapper extends EMBaseWrapper{
    ...
    public EMWrapperRoomListener emWrapperRoomListener;
    ...
    private void registerEaseListener() {
        emWrapperRoomListener = new EMWrapperRoomListener();
        EMClient.getInstance().chatroomManager().addChatRoomChangeListener(emWrapperRoomListener);
    }
}
