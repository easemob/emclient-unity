...
static NSString *const loadMsgWithScopeAndFromIds = @"loadMsgWithScopeAndFromIds";
...
static NSString *const createGroupWithAvatar = @"createGroupWithAvatar";
...
static NSString *const fetchGroupMemberInfoFromServer = @"fetchGroupMemberInfoFromServer";
...
static NSString *const onMembersJoinedFromGroup = @"onMembersJoinedFromGroup";
static NSString *const onMembersExitedFromGroup = @"onMembersExitedFromGroup";
